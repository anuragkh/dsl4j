...
public class DeltaEncodedIntVectorOps {
  ...
  public static int get(ByteBuffer vector, int i) {
    ...
    vector.position(vector.position() + sampleBlocks * SuccinctConstants.LONG_SIZE_BYTES);
    ...
    vector.position(vector.position() + deltaOffsetBlocks * SuccinctConstants.LONG_SIZE_BYTES);
